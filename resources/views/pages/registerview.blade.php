            ...
            <div class="col-sm-6 col-md-8 col-lg-7">
                <div class="card-register w-100">
                    <form action="{{ route('register') }}" method="POST" disabled>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin"
                                            id="radio_jenis_kelamin1" value="Laki Laki" required disabled>
                                        Laki Laki
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin"
                                            id="radio_jenis_kelamin2" value="Perempuan" required disabled>
                                        Perempuan
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-floating mb-3">
                            <select name="program_studi" class="form-control" aria-label="Program Studi" disabled>
                        ...
                        <div class="form-floating mb-3">
                            <textarea id="floatingInput" class="form-control textarea pt-4 px-3" name="alamat" placeholder="Masukkan Alamat Anda" disabled></textarea>
                            <label for="floatingInput" class="d-flex align-items-center">Masukkan Alamat Anda</label>
                        </div>
                        <div class="form-floating mb-3">
                        ...
                        <button type="submit" class="button-kontak" disabled>Daftar</button>
                    </form>
